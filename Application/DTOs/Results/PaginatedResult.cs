...
namespace smERP.Application.DTOs.Results
{
    public class PaginatedResult<T>
    {
        ...
        {
            return new(true, data, null, count, page, pageSize, HttpStatusCode.OK);
        }
        public static PaginatedResult<T> InternalServerError(List<T> data, int count, int page, int pageSize)
        {
            return new(false, new List<T>(), null, count, page, pageSize, HttpStatusCode.InternalServerError);
        }
        public static PaginatedResult<T> Unauthorized(List<T> data, int count, int page, int pageSize)
        {
            return new(false, new List<T>(), null, count, page, pageSize, HttpStatusCode.Unauthorized);
        }
        public static PaginatedResult<T> BadRequest(List<T> data, int count, int page, int pageSize)
        {
            return new(false, new List<T>(), null, count, page, pageSize, HttpStatusCode.BadRequest);
        }
